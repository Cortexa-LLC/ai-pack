...
pwd
# /Users/user/consumer-project/server/

# Agent executes (thinking it's in project root)
mkdir server/API

# Result
# /Users/user/consumer-project/server/server/API/  ← DISASTER!
```
...
## Real-World consumer-project Examples
...
**How It Happened:**
1. Agent thought pwd was `/Users/user/consumer-project/`
2. Reality: pwd was `/Users/user/consumer-project/server/`
3. Agent: `mkdir server/API`
4. Result: `/Users/user/consumer-project/server/server/API/`
...
- **Real Failure:** consumer-project nested server/server/* directories
