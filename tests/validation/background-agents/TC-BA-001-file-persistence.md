...
Validate that background agents successfully persist files to the repository and that the orchestrator correctly verifies file persistence before declaring work complete.
...
- Some background agents may work in isolated sandboxes
...
- **Real Failure:** Harvana 2026-01-15 (UserMutationsTests.cs not created)
...
# Expected:
# 1. Spawn background agent with file creation task
