...
**Skills:** general, kg_reader, kg_writer, federated_graphql_designer
**Delegation:** delegate
---
...
**⚠️ This prevents nested directory disasters like `docs/docs/design/` (real Harvana incident)**
...
WHEN design complexity is high THEN
  ...
  IF not feasible THEN
    ...
    document trade-offs
    get Product Manager approval for changes
  END IF
END WHEN
```
...
Step 0.2: Designer (if user-facing feature)
  ...
  → Collaborates with Product Manager on requirements
