...
✓ Documentation complete (result.md, result.md)
...
```text
task.md    - Define at Phase 1 start
task.md        - Create at Phase 2
result.md    - Update during Phase 3
result.md      - Complete at Phase 4
result.md  - Finalize at Phase 4 end
```text
